...
import { FaBuilding, FaCheckCircle, FaFileAlt, FaHourglassEnd, FaMoneyBillWave, FaTimesCircle, FaUsers } from 'react-icons/fa'
...
const AdminSummary = () => {
  ...
  useEffect(() => {
    const fetchSummary = async () => {
      try {
        const summary = await axios.get('https://employee-server-five.vercel.app/api/dashboard/summary', {
          headers: {
  ...
  return (
    <div className='p-6'>
        ...
        <div className='mt-10'>
        <h4 className='text-center text-2xl font-bold'>Leave Detail</h4>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
            ...
            <SummaryCard icon={<FaHourglassEnd/>}  text={"Leave Pending"} number={summary.leaveSummary.pending} color="bg-red-600"/>
